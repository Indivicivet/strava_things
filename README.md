...
after this you can run `download_all_streams.py` which will download all streams
...
`strava_shared.py` gives a basic interface for loading activities; this is then used by various scripts
...
remove cycles, walks, etc (and maybe architecture for these in the future?)
